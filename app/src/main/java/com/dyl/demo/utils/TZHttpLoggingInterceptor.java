 ...
 */
public final class TZHttpLoggingInterceptor implements Interceptor {
  ...
  public TZHttpLoggingInterceptor() {
    this(Logger.DEFAULT);
  }

  public TZHttpLoggingInterceptor(Logger logger) {
    this.logger = logger;
  }
  ...
  public TZHttpLoggingInterceptor setLevel(Level level) {
